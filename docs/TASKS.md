...
- [x] Round order and initiative bands (`06` section 3)
...
- [x] **Done when:** unknown potions, scrolls, and cursed gear behave exactly as `04` describes
...
- [x] Chest generation and the chest sequence; Chest / Door screen (`03` section 7)
